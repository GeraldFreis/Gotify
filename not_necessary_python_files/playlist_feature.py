...
def adding_songs_to_playlist(mainwin):
    ...
    def search_enter_command():
        global search_
        search_ = search_entry_text.get()
        real_search(search=search_)
        writing_search_to_db(search=search_)
        return search_
    ...
    def fixforbutton_1():
        ...
        song_author = 'hello'
        song_duration = 'he'
        writing_to_playlist_database(tablename=search_, songname=liked_song_1_name, songauthor=song_author, songduration=song_duration)
    ...
    def fixforbutton_2():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_2_name, songauthor='', songduration='')
    ...
    def fixforbutton_3():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_3_name, songauthor='', songduration='')
    ...
    def fixforbutton_4():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_4_name, songauthor='', songduration='')
    ...
    def fixforbutton_5():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_5_name, songauthor='', songduration='')
    ...
    def fixforbutton_6():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_6_name, songauthor='', songduration='')
    ...
    def fixforbutton_7():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_7_name, songauthor='', songduration='')
    ...
    def fixforbutton_8():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_8_name, songauthor='', songduration='')
    ...
    def fixforbutton_9():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_9_name, songauthor='', songduration='')
    ...
    def fixforbutton_10():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_10_name, songauthor='', songduration='')
    ...
    def fixforbutton_11():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_11_name, songauthor='', songduration='')
    ...
    def fixforbutton_12():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_12_name, songauthor='', songduration='')
    ...
    def fixforbutton_13():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_13_name, songauthor='', songduration='')
    ...
    def fixforbutton_14():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_14_name, songauthor='', songduration='')
    ...
    def fixforbutton_15():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_15_name, songauthor='', songduration='')
    ...
    def fixforbutton_16():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_16_name, songauthor='', songduration='')
    ...
    def fixforbutton_17():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_17_name, songauthor='', songduration='')
    ...
    def fixforbutton_18():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_18_name, songauthor='', songduration='')
    ...
    def fixforbutton_19():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_19_name, songauthor='', songduration='')
    ...
    def fixforbutton_20():
        ...
        writing_to_playlist_database(tablename=search_, songname=liked_song_20_name, songauthor='', songduration='')
    ...
    try:
        ...
        def fixforrecentbutton_1():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_1_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_2():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_2_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_3():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_3_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_4():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_4_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_5():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_5_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_6():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_6_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_7():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_7_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_8():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_8_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_9():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_9_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_10():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_10_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_11():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_11_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_12():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_12_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_13():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_13_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_14():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_14_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_15():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_15_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_16():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_16_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_17():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_17_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_18():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_18_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_19():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_19_name, songauthor='', songduration='')
        ...
        def fixforrecentbutton_20():
            ...
            writing_to_playlist_database(tablename=search_, songname=recent_song_20_name, songauthor='', songduration='')
